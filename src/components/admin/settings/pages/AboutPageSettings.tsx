...
const defaults: AboutPageData = {
  hero_title: "About Best E-Shop",
  hero_description: "Best E-Shop is a premium gadget destination in Bangladesh. We bring you the latest in technology — from smartphones and smartwatches to gaming gear and audio accessories — all backed by genuine warranty and exceptional service.",
  story_title: "Our Story",
  story_p1: "Founded with a passion for technology, Best E-Shop started as a small venture to make premium gadgets accessible to everyone in Bangladesh.",
